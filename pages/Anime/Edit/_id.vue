    ...
    <div id="test1" class="content-body" style="width: max-content">
        <div class="row" style="width: 100%; display: block">
            ...
            <div class="col-12 display-start nopadding">
                ...
                <div class="input-group nopadding" style="width: 50%; padding: 0 1rem; display: block">
            ...
            <div class="col-12 display-start nopadding">
                <div class="col-6 input-group nopadding-bottom">
        ...
        <div class="text-end col-12 display-start" style="margin-top: 1rem; display: flex; justify-content: flex-end">
