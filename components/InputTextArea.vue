<template>
    <div>
        ...
        <div class="input-group">
            <textarea type="text" class="input-all form-control ng-pristine ng-valid ng-touched" :class="status_value == false ? 'alert-input' : ''" v-on:input="$emit('input', $event.target.value)" rows="6" style="height: 200px; padding: 10px;">{{ value }}</textarea>
