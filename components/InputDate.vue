<template>
    <div>
        ...
        <div class="input-group">
            <input type="date" class="input-all form-control ng-pristine ng-valid ng-touched" :class="status_value == false ? 'alert-input' : ''" :value="value" v-on:input="$emit('input', $event.target.value)" style="width: 280px !important" />
